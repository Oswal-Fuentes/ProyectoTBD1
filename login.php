...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>UNITEC | Iniciar sesion</title>
...
<body>
    <div class="navbar navbar-inverse set-radius-zero">
        <div class="container">
            <div class="left-div">
                <a href="index.html"><img src="assets/img/unitec-logo.png"/></a>
            </div>
        </div>
    </div>
    <!-- LOGO HEADER END-->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <br />
                    <label for="txt-username-login">Usuario: </label>
                    <input type="text" class="form-control" id="txt-username-login" />
                ...
                <div class="col-md-6">
                    <div class="alert alert-success">
                        ...
                        <ul>
                            <li>
                               Utilize su <b>nombre de usuario</b> para iniciar sesion, no su correo electronico.
                            </li>
                            <li>
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul>
                            ...
                            <li>
                                Si tiene problemas con el sistema, llamar al +504 22280848
                            </li>
                            <li>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    IS420 Septiembre, 2018  |  Grupo 5</a>
                </div>
            </div>
        </div>
    </footer>
