            ...
            <div class="row">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group" id="div-slc-registro-prueba" >
                          <label class="control-label" for="slc-registro-prueba">Numero de Registro:</label>
                          <?php echo Avion::generarSelectRegistro($link); ?>
                        </div>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <table class="table table-striped table-hover" id="pruebas">
                                <th></th>
                    ...
                    <div class="panel-footer">
                    <button class="btn btn-primary btn-xs hidden" id="btn-nueva-Prueba-editar"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button>
